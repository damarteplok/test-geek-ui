							...
							<Dropdown className='relative flex items-center h-header'>
								...
								>
									{user.avatar ? (
										...
										<div className='flex items-center justify-center size-10 rounded-full bg-custom-100 text-custom-500 dark:bg-custom-950'>
											{user.name ? user.name.charAt(0).toUpperCase() : 'NaN'}
										</div>
									)}
								</Dropdown.Trigger>
								<Dropdown.Content
